...
var app = (function () {
  ...
  function dispatch_dev(type, detail) {
    document.dispatchEvent(
      custom_event(type, Object.assign({ version: '3.43.1' }, detail), true)
    )
  }
  ...
  class Snake {
    ...
    move() {
      ...
      try {
        ...
        if (
          Utils.getElm(`i-${this.head.x}-${this.head.y}`).classList.contains(
            'snake'
          )
        ) {
  ...
  class Board {
    ...
    _checkHeadForFood(xAxis, yAxis) {
      if (
        ...
        Utils.hasClass(`i-${xAxis}-${yAxis}`, 'food')
      ) {
  ...
  function instance$1($$self, $$props, $$invalidate) {
    ...
    Object.keys($$props).forEach((key) => {
      if (
        ...
        console.warn(`<MediaQuery> was created with unknown prop '${key}'`)
    })
    ...
    $$self.$inject_state = ($$props) => {
      ...
      if ('wasMounted' in $$props)
        $$invalidate(2, (wasMounted = $$props.wasMounted))
  ...
  class MediaQuery extends SvelteComponentDev {
    ...
    get query() {
      throw new Error(
        "<MediaQuery>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }

    set query(value) {
      throw new Error(
        "<MediaQuery>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'"
      )
    }
  }
    ...
    const block = {
      c: function create() {
        ...
        attr_dev(
          div2,
          'class',
          'control-group control-group-3 rotated svelte-1dq6dpi'
        )
  ...
  function create_fragment(ctx) {
    ...
    const block = {
      c: function create() {
        ...
        if (!src_url_equal(img0.src, (img0_src_value = '/github.png')))
        ...
        if (!src_url_equal(img1.src, (img1_src_value = '/linkedin.png')))
        ...
        if (!src_url_equal(img2.src, (img2_src_value = '/twitter.png')))
  ...
  function instance($$self, $$props, $$invalidate) {
    ...
    $$self.$inject_state = ($$props) => {
      if ('dimension' in $$props)
        $$invalidate(0, (dimension = $$props.dimension))
      if ('maxFood' in $$props) maxFood = $$props.maxFood
      if ('smallestInterval' in $$props)
        smallestInterval = $$props.smallestInterval
      ...
      if ('gameStatus' in $$props)
        $$invalidate(2, (gameStatus = $$props.gameStatus))
