      ...
      >
        {#each grid as row, tIndex}
          {#each row as cell, bIndex}
            <div
              id={"i-" + bIndex + "-" + tIndex}
              class="cell {cell === 1 ? 'snake' : ''} {cell === 2
                ? 'food'
                : ''} {cell === 3 ? 'head' : ''}"
            />
          {/each}
    ...
    {#if matches}
      <div class="mobile-control">
        <div class="control-group control-group-1">
          <span
            class="control-node control-up"
            on:click={(evt) => handleMobileButtonClick(evt, "UP")}
          >
            ^
          </span>
        </div>
        <div class="control-group control-group-2">
          <span
            class="control-node control-left"
            on:click={(evt) => handleMobileButtonClick(evt, "LEFT")}
          >
            &lt;
          </span>
          <span
            class="control-node control-start"
            on:click={(evt) => handleMobileButtonClick(evt, "SPACE")}
          >
            0</span
          >
          <span
            class="control-node control-right"
            on:click={(evt) => handleMobileButtonClick(evt, "RIGHT")}
          >
            &gt;
          </span>
        </div>
        <div class="control-group control-group-3 rotated">
          <span
            class="control-node control-down "
            on:click={(evt) => handleMobileButtonClick(evt, "DOWN")}
          >
            ^
          </span>
        </div>
